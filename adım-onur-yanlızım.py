...
def ping():
	print
	print
	os.system("toilet -f pagga 'SoAyHg Hack       ' | lolcat")
	time.sleep(1)
	print
...
def nmap():
	print
	print
	os.system("toilet -f pagga 'SoAyHg Attack       ' | lolcat")
	time.sleep(1)
	print
...
print
def mnu():
	print "\033[1m\033[32m[+]\033[36m SoAyHg Attack"
	print "\033[32m[+] \033[36mSoAyHg Hack"
	print "\033[32m[+] \033[36mSoAyHg Hack"
	print "\033[32m[+] \033[36mSoAyHg Hack"
	print "\033[32m[+] \033[36mSoAyHg Hack"
	print "\033[32m[+] \033[36mSoAyHg Hack"
...
print
print
print "\033[1m\033[32mSoAyHg Yüklendi..."
print
ip = raw_input("\033[1m\033[32m Site ismi ? : \033[33m\033[1m")
print
time.sleep(3)
whois()
dns()
